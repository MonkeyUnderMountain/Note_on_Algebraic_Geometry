...
\begin{document}
    ...
    \input{Introduction_to_moduli_problems/text.tex}
    \input{The_Quot_functor/text.tex}
    \input{The_picard_functor/text.tex}
    \input{Moduli_of_curves/text.tex}
    \input{Moduli_of_vector_bundles/text.tex}
