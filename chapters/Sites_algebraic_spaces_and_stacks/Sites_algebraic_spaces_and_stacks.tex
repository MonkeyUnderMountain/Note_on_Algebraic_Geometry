...
\title{Algebraic spaces and stacks}
\author{Tianle Yang}
\date{\today}
...
\begin{document}
    ...
    % \input{Sites/text.tex} % 这里是正文
    % \input{Stacks_in_category_theory/text.tex}
    \input{Preliminaries_in_category_theory/text.tex}
    \input{Algebraic_spaces/text.tex}
    \input{Algebraic_stacks/text.tex}
